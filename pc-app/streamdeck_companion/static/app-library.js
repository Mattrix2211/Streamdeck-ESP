 ...
 * applications detectees (menu Demarrer, via app_library.py) + applications
 * personnalisees ajoutees via la tuile "+ Ajouter", persistees cote serveur
 * (custom_apps.py). Chargee une seule fois par session, la tuile
 * "+ Ajouter" met a jour le cache local ensuite sans recharger. Depend des
 * variables/elements definis dans dashboard.js (charge avant ce fichier). */
